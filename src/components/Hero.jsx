...
const Hero = () => {
  return (
    <section className="relative h-screen lg:h-[86vh] lg:mt-[15vh] w-full overflow-visible flex items-center justify-center bg-black">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="relative z-10 text-center text-white px-8 max-w-3xl" data-aos="fade-down">
        ...
        <a
          href="#agenda"
          className="mt-5 relative inline-block py-2 px-4 rounded-full uppercase font-sen text-tertiary overflow-hidden bg-[#B7B325] group"
        >
          <div className="absolute inset-0 bg-verdeoscuro opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
          <span className="relative z-10 font-medium xl:text-[20px] flex flex-row  items-center">Agenda una sesión <img src={Tulipan} className="w-8 h-8" /></span>
        </a>
      </div>
      ...
      <div className="hidden md:flex absolute bottom-12 right-[5%] space-x-3 bg-white/10 px-3 py-3 rounded-full border-2 border-white" data-aos="fade-left">
